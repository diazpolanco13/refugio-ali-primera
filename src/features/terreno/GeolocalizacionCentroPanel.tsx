  ...
  return (
    <Card className="@container flex min-h-0 flex-1 flex-col overflow-hidden shadow-lg">
      ...
      <CardContent className="min-h-0 flex-1 space-y-3 overflow-y-auto pb-2">
        {centro && (
          <div className="grid grid-cols-1 gap-2.5 rounded-lg border border-border bg-muted/30 px-3 py-2.5 sm:grid-cols-2 @2xl:grid-cols-4">
        ...
        <MapaGeolocalizacionCentro
          altura="h-64 min-h-[16rem] @2xl:h-[26rem]"
          lat={lat}
          lng={lng}
          onChange={(la, ln) => {
            setLat(la);
