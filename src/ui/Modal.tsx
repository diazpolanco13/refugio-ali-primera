...
export function Modal({ titulo, children, onCerrar }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-0 sm:items-center sm:p-4">
      ...
      <div className="flex max-h-[96dvh] w-full flex-col overflow-hidden rounded-t-2xl border-x-0 border-b-0 border-slate-700 bg-slate-900 shadow-2xl sm:max-h-[90vh] sm:max-w-md sm:rounded-2xl sm:border">
