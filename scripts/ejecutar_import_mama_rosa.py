#!/usr/bin/env python3
"""Ejecuta la importación de MAMA.txt vía Supabase REST (censo_registrar)."""
...
def load_importer():
    spec = importlib.util.spec_from_file_location(
        "importar_censo_mama_rosa",
        ROOT / "scripts" / "importar_censo_mama_rosa.py",
    )
...
def main():
    ...
    resumen = {
        ...
        "centro_nombre": "CEIN Mamá Rosa, Urb La Limonera",
