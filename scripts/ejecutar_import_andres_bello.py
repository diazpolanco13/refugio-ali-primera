#!/usr/bin/env python3
"""Ejecuta la importación de andres bello.txt vía Supabase REST (censo_registrar)."""
...
def load_importer():
    spec = importlib.util.spec_from_file_location(
        "importar_censo_andres_bello",
        ROOT / "scripts" / "importar_censo_andres_bello.py",
    )
...
def main():
    ...
    resumen = {
        ...
        "detalle_errores": resultados["error"][:30],
    }
