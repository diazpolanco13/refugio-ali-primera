#!/usr/bin/env python3
"""Ejecuta la importación de cesar rengifo.txt vía Supabase REST (censo_registrar)."""
...
def load_importer():
    spec = importlib.util.spec_from_file_location(
        "importar_censo_cesar_rengifo",
        ROOT / "scripts" / "importar_censo_cesar_rengifo.py",
    )
...
def main():
    ...
    resumen = {
        ...
        "centro_nombre": "UE Cesar Rengifo",
